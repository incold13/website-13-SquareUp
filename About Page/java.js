...
const storyContainer = document.getElementById('story_grid_container');

storyContainer.innerHTML = storyData.map(item => `
    <div class="story_item">
        <div class="inner_wrapper">
            <div class="top_row">
                <span class="step_number">${item.id}</span>
                <div class="spacer_x_large"></div>
                <h3 class="step_title">${item.title}</h3>
            </div>
